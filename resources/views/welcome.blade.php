                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                        <div class="space-y-3">
                            <div class="flex items-center space-x-3">
                                <span class="px-2 py-1 text-xs font-semibold text-green-800 dark:text-green-200 bg-green-100 dark:bg-green-900 rounded">GET</span>
                                <code class="text-sm text-gray-600 dark:text-gray-400">/api/contexts</code>
                                <span class="text-sm text-gray-500 dark:text-gray-400">- List all user contexts</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <span class="px-2 py-1 text-xs font-semibold text-blue-800 dark:text-blue-200 bg-blue-100 dark:bg-blue-900 rounded">POST</span>
                                <code class="text-sm text-gray-600 dark:text-gray-400">/api/contexts</code>
                                <span class="text-sm text-gray-500 dark:text-gray-400">- Create new context</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <span class="px-2 py-1 text-xs font-semibold text-green-800 dark:text-green-200 bg-green-100 dark:bg-green-900 rounded">GET</span>
                                <code class="text-sm text-gray-600 dark:text-gray-400">/api/contexts/{id}</code>
                                <span class="text-sm text-gray-500 dark:text-gray-400">- Get context details</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <span class="px-2 py-1 text-xs font-semibold text-yellow-800 dark:text-yellow-200 bg-yellow-100 dark:bg-yellow-900 rounded">PUT</span>
                                <code class="text-sm text-gray-600 dark:text-gray-400">/api/contexts/{id}</code>
                                <span class="text-sm text-gray-500 dark:text-gray-400">- Update context</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <span class="px-2 py-1 text-xs font-semibold text-red-800 dark:text-red-200 bg-red-100 dark:bg-red-900 rounded">DELETE</span>
                                <code class="text-sm text-gray-600 dark:text-gray-400">/api/contexts/{id}</code>
                                <span class="text-sm text-gray-500 dark:text-gray-400">- Delete context</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <span class="px-2 py-1 text-xs font-semibold text-green-800 dark:text-green-200 bg-green-100 dark:bg-green-900 rounded">GET</span>
                                <code class="text-sm text-gray-600 dark:text-gray-400">/api/profile/{token}</code>
                                <span class="text-sm text-gray-500 dark:text-gray-400">- Access profile via sharing token</span>
                            </div>
                        </div>
                    </div>
                </div>
