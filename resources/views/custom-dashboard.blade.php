<x-app-layout>
    ...
    <div class="py-12" x-data="dashboardApp()">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <button onclick="Livewire.dispatch('open-create-context-modal')"
        ...
        <!-- Filament Forms Create/Edit Context Modal -->
        @livewire('create-context')
        
        <!-- Filament Forms Manage Attribute Modal -->
        @livewire('manage-attribute')
